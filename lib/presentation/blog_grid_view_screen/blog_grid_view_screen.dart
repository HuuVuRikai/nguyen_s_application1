import '../blog_grid_view_screen/widgets/blog_grid_view_item_widget.dart';
...
class BlogGridViewScreen extends GetWidget<BlogGridViewController> {
  @override
                          ...
                          child: Padding(
                            ...
                            child: Obx(
                              () => ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: controller.blogGridViewModelObj.value
                                    .blogGridViewItemList.length,
                                itemBuilder: (context, index) {
                                  BlogGridViewItemModel model = controller
                                      .blogGridViewModelObj
                                      .value
                                      .blogGridViewItemList[index];
                                  return BlogGridViewItemWidget(
                                    model,
                                  );
                                },
                              ),
